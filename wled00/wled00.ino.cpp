# 1 "/var/folders/yc/t5g5_vrd3m1dd8mfygks58qr0000gn/T/tmp0AmysP"
#include <Arduino.h>
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled00.ino"
# 24 "/Users/fliegl/proj/WLED.baycom/wled00/wled00.ino"
...
void initIR();
void handleIR();
#line 478 "/Users/fliegl/proj/WLED.baycom/wled00/wled00.ino"
int SMAGenerator(int val)
{
...
float readBatteryLevel()
{
  ...
  return 5.0587559809 * (float)val / 4096.0f;
}
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled01_eeprom.ino"
...
#define EEPVER 14
# 28 "/Users/fliegl/proj/WLED.baycom/wled00/wled01_eeprom.ino"
void commit()
{
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled02_xml.ino"
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled03_set.ino"
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled04_file.ino"
...
#endif
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled05_init.ino"
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled06_usermod.ino"
# 11 "/Users/fliegl/proj/WLED.baycom/wled00/wled06_usermod.ino"
void userSetup()
{
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled07_notify.ino"
...
void notify(byte callMode, bool followUp=false)
{
  ...
  switch (callMode)
  {
    ...
    case 6: if (!notifyDirect) return; break;
...
void handleE131Packet(e131_packet_t* p, IPAddress clientIP){
  ...
  uint16_t multipacketOffset = (uni - e131Universe)*170;
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled08_led.ino"
...
void colorUpdated(int callMode)
{
  ...
  if (callMode != 0 && callMode != 1 && callMode != 5) strip.applyToAllSelected = true;
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled09_button.ino"
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled10_ntp.ino"
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled11_ol.ino"
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled12_alexa.ino"
# 9 "/Users/fliegl/proj/WLED.baycom/wled00/wled12_alexa.ino"
#ifndef WLED_DISABLE_ALEXA
...
void onAlexaChange(EspalexaDevice* dev)
{
 ...
 void handleAlexa(){}
#endif
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled13_cronixie.ino"
...
{
  #ifndef WLED_DISABLE_CRONIXIE
# 86 "/Users/fliegl/proj/WLED.baycom/wled00/wled13_cronixie.ino"
  DEBUG_PRINT("cset ");
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled14_colors.ino"
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled15_hue.ino"
...
void reconnectHue(){}
#endif
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled16_blynk.ino"
...
#endif
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled17_mqtt.ino"
...
void publishMqtt(){}
#endif
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled18_server.ino"
...
String msgProcessor(const String& var)
{
  if (var == "MSG") {
    ...
    {
      messageBody += "<br><br><form action=/settings><button class=\"bt\" type=submit>Back</button></form>";
    } else if (optt == 254)
    {
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled19_json.ino"
...
# 1 "/Users/fliegl/proj/WLED.baycom/wled00/wled20_ir.ino"
...
bool decodeIRCustom(uint32_t code)
{
  ...
  if (code != IRCUSTOM_MACRO1) colorUpdated(2);
  return true;
}
